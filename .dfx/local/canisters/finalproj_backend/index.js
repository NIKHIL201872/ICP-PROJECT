...
import { idlFactory } from './finalproj_backend.did.js';
export { idlFactory } from './finalproj_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FINALPROJ_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finalproj_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the finalproj_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finalproj_backend.did.js")._SERVICE>}
 */
export const finalproj_backend = createActor(canisterId);
