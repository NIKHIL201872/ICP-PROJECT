...
import { idlFactory } from './finalproj_frontend.did.js';
export { idlFactory } from './finalproj_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FINALPROJ_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./finalproj_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the finalproj_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./finalproj_frontend.did.js")._SERVICE>}
 */
export const finalproj_frontend = createActor(canisterId);
